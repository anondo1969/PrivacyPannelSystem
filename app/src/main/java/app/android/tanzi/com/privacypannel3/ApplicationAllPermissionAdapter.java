...
/**
 * Created by Entu on 3/21/2016.
 */
public class ApplicationAllPermissionAdapter extends ArrayAdapter{
    String[] application_permission_text;

    public ApplicationAllPermissionAdapter(Context context, String[] text) {
