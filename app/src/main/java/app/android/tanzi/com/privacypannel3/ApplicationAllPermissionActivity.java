...
public class ApplicationAllPermissionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_application_all_permission);

        String[] permissionNames = data_source.loadPermissionName();

        final ApplicationAllPermissionAdapter applicationAllPermissionAdapter = new ApplicationAllPermissionAdapter(this, permissionNames);
        ListView applicationPermissionView = (ListView) findViewById(R.id.application_permission_list_view);
        applicationPermissionView.setAdapter(applicationAllPermissionAdapter);

        applicationPermissionView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Object item = applicationAllPermissionAdapter.getItem(position);
