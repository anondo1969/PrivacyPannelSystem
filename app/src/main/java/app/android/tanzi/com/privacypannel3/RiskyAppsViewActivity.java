...
public class RiskyAppsViewActivity extends AppCompatActivity {
    ...
    RiskyAppsViewAdapter riskyAppsViewAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_risky_apps_view);
...
//            Log.d("TanziLogg", Integer.toString(checkValueList.size()));
        }
        else{
//            Log.d("OneTime: ", "not");
        ...
        riskyAppsViewAdapter = new RiskyAppsViewAdapter(this, application_list,  locationList);
        ...
        locationListView.setAdapter(riskyAppsViewAdapter);
...
//        Log.d("Anondo", "Inside onPause");
        int pos=-1;
        Boolean[] values = riskyAppsViewAdapter.saveValues();
