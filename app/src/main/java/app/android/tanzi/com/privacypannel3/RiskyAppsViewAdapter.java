...
/**
 * Created by Entu on 3/23/2016.
 */
public class RiskyAppsViewAdapter extends ArrayAdapter {
...
//    boolean[] selectedPosition2 = new boolean[4];
    ...
    public RiskyAppsViewAdapter(Context context, String[] text, ArrayList<Boolean> checkBoxSelect) {
