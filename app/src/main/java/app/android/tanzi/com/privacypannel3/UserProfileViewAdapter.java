...
//                    Log.d("TanziLog", logg);
                    ...
                    Toast.makeText(getContext(), "To change individual Application security" +
                            "\nPlease go to Location Accuracy Menu", Toast.LENGTH_LONG).show();
